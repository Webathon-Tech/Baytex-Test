...
output "databricks_workspace_url" {
  value = "https://${module.databricks_workspace.databricks_workspace_url}"
}
...
output "unity_catalog_handoff" {
  value = {
    ...
    workspace_url                 = "https://${module.databricks_workspace.databricks_workspace_url}"
    workspace_arm_id              = module.databricks_workspace.databricks_id
