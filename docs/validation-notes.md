...
| Default storage firewall | When enabled, classic and serverless compute read and write the workspace root storage, and the root storage account refuses public network access |
