...
> | **[PIPELINES.md](PIPELINES.md)** | **Start here for CI/CD** — every workflow, the developer journey, promotion/hotfix/rollback strategies, concurrency |
> | **[GITHUB-SETUP.md](GITHUB-SETUP.md)** | What to configure in GitHub: environments, variables, protection rules, branch protection |
